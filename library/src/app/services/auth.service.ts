...
export class AuthService {
  users: Compte[] = [
    ...
    {"nom":"Raja Barhoumi", "email":"raja@gmail.com", "mot2pass":"azerty", "role":"AGENT"},
    {"nom":"First Project", "email":"first@gmail.com", "mot2pass":"beginner", "role":"AGENT"}, 
    // A remplacer par votre nom et email
    ];
    userCourant! : string;
  ...
  disconnect() {
    ...
    connect(user : Compte) : boolean {
      ...
      localStorage.setItem('userCourant',String(this.userCourant) );
      localStorage.setItem('isConnected', String(this.isConnected));
      }
      });
